...
namespace SME.SERAp.Prova.Acompanhamento.Dominio.Constraints
{
    public static class Perfis
    {
        ...
        public static bool PerfilEhValido(string perfil)
        {
        ...
        public static bool PerfilEhAdministrador(string perfil)
        {
            ...
            return ehGuid &&
                ...
                (guidPerfil == Perfis.PERFIL_ADMINISTRADOR || guidPerfil == Perfis.PERFIL_ADMINISTRADOR_SERAP_DRE);
        }

        public static IEnumerable<Guid> ToList()
        {
            var lista = new List<Guid>
            {
                PERFIL_ADMINISTRADOR,
                PERFIL_ADMINISTRADOR_SERAP_DRE,
                PERFIL_ADMINISTRADOR_NTA,
                PERFIL_ADMINISTRADOR_SERAP_UE,
                PERFIL_ASSISTENTE_DIRETOR_UE,
                PERFIL_COORDENADOR_PEDAGOGICO,
                PERFIL_DIRETOR_ESCOLAR
            };
